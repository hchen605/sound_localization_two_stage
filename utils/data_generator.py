...
class DataGenerator(object):
    ...
    def __init__(self, args, hdf5_dir, logging=logging):
        ...
        train_splits = train_splits_dict[args.fold] #fold for cross validation
        ...
        for hdf5_fn in self.train_hdf5_fn:
            ...
            feature, target_event, target_doa, target_dist = \
                self.load_hdf5(hdf5_path) #return feature, target_event, target_doa, target_dist
    ...
    def load_hdf5(self, hdf5_path):#load from dataset hdf5
        '''
        Load hdf5. 
